...
``` {r echo=TRUE}
rain = read.table("rnf6080.dat",header=FALSE)
head(rain)
```
...
names(rain) <- c("year","month","day",paste("Hour", 0:23, sep = ""))
rain
```
...
sumsplot = rowSums(rain, na.rm=FALSE, 1:23)
hist(sumsplot)
